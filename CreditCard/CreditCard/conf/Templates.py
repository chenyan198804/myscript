...
#用户中心按键对应功能模块
user_center_func = {
                    "1":{"module":"module.users","func":"modify_password"},
                    "2":{"module":"module.users","func":"modify_user_info"},
                    "3":{"module":"module.report","func":"print_bill_history"},
                    "4":{"module":"module.report","func":"print_shopping_history"},
                    "5":{"module":"module.users","func":"logout"},
                    }


#购物车模板主菜单，menu菜单在shopping模块中内部构造
shopping_index_menu = '''
----------------------------------------------------------------
------                                                    ------
------                  信用卡购物商城                                             ------
...
----------------------------------------------------------------
                                                用户基本信息
用户名:{username}           姓名:{name}            手机:{mobile}
...
{billdata} {sdate}至{edate}   {pdate}    {total}    {payed}    {interest}
----------------------------------------------------------------    
账单明细:
            交易时间                交易类型                交易金额                流水号
{detail}
